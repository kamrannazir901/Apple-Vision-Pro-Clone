...
const topbarLinks = document.querySelectorAll(".topbarnav a");

const megumenu = document.querySelector(".megamenudiv");
...
megumenu.addEventListener("mouseleave", () => {
  gsap.to(megumenu, {
...
downicon.addEventListener("click", () => {
  document.querySelector(".mobile-main-nav").classList.toggle("open");
});

// mobile topbarmenu

const closeicon = document.querySelector(".mobile-topbarnav .megamenu-icons i");
const humberger = document.querySelector("#humberger");
humberger.addEventListener("click", () => {
  document.querySelector(".mobile-topbarnav").classList.add("open");
  document.body.style.overflowY = "hidden";
});

closeicon.addEventListener("click", () => {
  document.querySelector(".mobile-topbarnav").classList.remove("open");
...
ScrollTrigger.matchMedia({
  "(min-width: 1000px)": function () {
    ...
    gsap.to(".section1 .herocontent", {
      scrollTrigger: {
        scroller: "body",
        trigger: ".section1 .herocontent",
        start: "-50% top",
        end: "-40% bottom",
        scrub: 1,
      },
...
function canvas2() {
  const canvas = document.querySelector(".section17-2>canvas");
  const context = canvas.getContext("2d");
